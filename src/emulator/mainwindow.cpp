...
#include "../qt/spectrumthreadpauser.h"
...
{
    SpectrumThreadPauser pauser(m_spectrumThread);
...
void MainWindow::loadZ80Snapshot(const QString & fileName)
{
    ...
    m_display.setBorder(static_cast<SpectrumDisplayDevice::Colour>((fileFormatFlags & 0b00001110) >> 1));
