...
#ifndef SPECTRUM_PAGINGDEVICEPLUS2A_H
#define SPECTRUM_PAGINGDEVICEPLUS2A_H
...
namespace Spectrum::Devices
{
    ...
    public:
         ...
         * @param owner
         */
        explicit PagingDevicePlus2a(SpectrumPlus2a & owner)
        : m_pagingEnabled(true),
          m_spectrum(owner)
        {}

        ~PagingDevicePlus2a() override;
         ...
         */
        [[nodiscard]]
        bool checkReadPort(::Z80::UnsignedWord port) const noexcept override
        {
            return false;
        }
         ...
         */
        [[nodiscard]]
        bool checkWritePort(const ::Z80::UnsignedWord port) const override
        {
         ...
         * @return
         */
        Z80::UnsignedByte readByte(::Z80::UnsignedWord port) noexcept override
        {
            return 0xff;
        }
         ...
         */
        [[nodiscard]]
        const SpectrumPlus2a & spectrum() const noexcept
        {
            return m_spectrum;
        }
         ...
         */
        SpectrumPlus2a & spectrum() noexcept
        {
            return m_spectrum;
        }
         ...
         */
        [[nodiscard]] bool pagingEnabled() const noexcept
        {
         ...
         * @param enabled
         */
        void setPagingEnabled(const bool enabled) noexcept
        {
...
#endif //SPECTRUM_PAGINGDEVICEPLUS2A_H
