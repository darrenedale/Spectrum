...
namespace
{
    constexpr std::uint16_t Joystick1UpMask = 0x0001;
    constexpr std::uint16_t Joystick1DownMask = 0x0002;
    constexpr std::uint16_t Joystick1LeftMask = 0x0004;
    constexpr std::uint16_t Joystick1RightMask = 0x0008;
    constexpr std::uint16_t Joystick1Button1Mask = 0x0010;
    constexpr std::uint16_t Joystick1Button2Mask = 0x0020;
    constexpr std::uint16_t Joystick1Button3Mask = 0x0040;

    constexpr std::uint16_t Joystick2UpMask = 0x0100;
    constexpr std::uint16_t Joystick2DownMask = 0x0200;
    constexpr std::uint16_t Joystick2LeftMask = 0x0400;
    constexpr std::uint16_t Joystick2RightMask = 0x0800;
    constexpr std::uint16_t Joystick2Button1Mask = 0x1000;
    constexpr std::uint16_t Joystick2Button2Mask = 0x2000;
    constexpr std::uint16_t Joystick2Button3Mask = 0x4000;
}
