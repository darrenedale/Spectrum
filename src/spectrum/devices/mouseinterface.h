...
namespace Spectrum::Devices
{
    ...
    public:
        ...
        ~MouseInterface() override = default;
         ...
         */
        [[nodiscard]]
        bool checkWritePort(::Z80::UnsignedWord) const override
        {
            return false;
        }
         ...
         */
        [[nodiscard]]
        virtual bool button1Pressed() const;
         ...
         */
        [[nodiscard]]
        virtual bool button2Pressed() const;
         ...
         */
        [[nodiscard]]
        virtual bool button3Pressed() const;
