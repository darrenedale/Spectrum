...
namespace Spectrum::Memory
{
    ...
    public:
        ...
        MemoryPlus2a(const MemoryPlus2a &) = delete;

        /** Move construction is disabled. */
        MemoryPlus2a(MemoryPlus2a &&) = delete;

        /** Copy assignment is disabled. */
        void operator=(const MemoryPlus2a &) = delete;

        /** Move assignment is disabled. */
        void operator=(MemoryPlus2a &&) = delete;

        ~MemoryPlus2a() override;
         ...
         */
        [[nodiscard]]
        PagingMode pagingMode() const noexcept
        {
            return m_pagingMode;
        }
         ...
         */
        void setPagingMode(const PagingMode mode)
        {
            m_pagingMode = mode;
        }
         ...
         */
        [[nodiscard]]
        SpecialPagingConfiguration specialPagingConfiguration() const noexcept
        {
         ...
         */
        void setSpecialPagingConfiguration(const SpecialPagingConfiguration config) noexcept
        {
